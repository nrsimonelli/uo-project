...
export const PassiveSkills = [
  ...
  {
    id: 'shatteringPursuit',
    type: 'passive',
    name: 'Shattering Pursuit',
    description:
      'Activates after an ally attacks (Active). Follow-up attack a column of enemies with a piercing strike. Inflicts Phys. Defense -25%.',
    pp: 1,
    skillCategories: ['Damage', 'Pursuit'],
    activationWindow: 'afterAllyAttacksActive',
    targeting: {
  ...
  },
  {
    ...
    name: 'Phalanx Shift',
    description:
      'Activates after an ally is attacked with an active skill. Buff a row of allies. Grants +20% Attack and +40% Critical Rate vs Cavalry targets.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'afterAllyAttackedActive',
    targeting: {
      group: 'Ally',
      pattern: 'Row',
    },
  ...
  },
  {
    ...
    name: 'Aerial Shift',
    description:
      'Activates after an ally is attacked with an active skill. Buff a row of allies. Grants +20% Attack and +40% Critical Rate vs Flying targets.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'afterAllyAttackedActive',
    targeting: {
  ...
  },
  {
    ...
    name: 'Healing Hunter',
    description:
      "Activates after an enemy uses healing magic. Attack a single enemy. Ignores 30% of the target's Defense.",
    pp: 1,
    skillCategories: ['Damage', 'Pursuit'],
    activationWindow: 'afterEnemyHeals',
    targeting: {
      group: 'Enemy',
      pattern: 'Single',
    },
  ...
  },
  {
    ...
    name: 'Rapid Shot',
    description:
      'Activates at the start of a battle. Attack a single enemy with a first strike. Inflicts Stun.',
    pp: 1,
    skillCategories: ['Damage'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Magic Burst',
    description:
      'Activates after an enemy attacks with an active skill. Counterattack all enemies with magic. Inflicts Initiative -10.',
    pp: 3,
    skillCategories: ['Damage', 'Counter'],
    activationWindow: 'afterEnemyAttacksActive',
    targeting: {
  ...
  },
  {
    ...
    name: 'Protection',
    description:
      'Activates before an ally is attacked. Reduce the damage taken by a row of allies by 50% for one attack.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'beforeAllyAttacked',
    targeting: {
  ...
  },
  {
    ...
    name: 'Quick Barrier',
    description:
      'Activates before an ally is attacked. Reduce the damage taken by an ally by 50% for one attack.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'beforeAllyAttacked',
    targeting: {
  ...
  },
  {
    ...
    name: 'Sacred Cure',
    description:
      'Activates after an ally is debuffed. Remove all debuffs from a row of allies. Grants targets immunity to one debuff.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'afterAllyDebuffed',
    targeting: {
  ...
  },
  {
    ...
    name: 'Reheal',
    description:
      'Activates at the start of a battle. Grants a row of allies HP Regeneration.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Magic Shell',
    description:
      'Activates at the start of a battle. Complete negate attacks up to three hits.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Hastened Curse',
    description:
      'Activates at the start of a battle. Inflicts -30 Initiative on a single enemy.',
    pp: 1,
    skillCategories: ['Sabotage'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Guard Hunter',
    description:
      "Activates after an enemy guards an attack. Attack a single enemy with magic. Ignores 30% of the target's Defense.",
    pp: 1,
    skillCategories: ['Damage', 'Pursuit'],
    activationWindow: 'afterEnemyGuards',
    targeting: {
      group: 'Enemy',
      pattern: 'Single',
    },
  ...
  },
  {
    ...
    name: 'Poison Burst',
    description:
      'Activates at the end of a battle. Attack a single enemy with magic. Hits all enemies if target is poisoned.',
    pp: 1,
    skillCategories: ['Damage'],
    activationWindow: 'endOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Maidens Hammer',
    description:
      'Activates after an enemy attacks with an active skill. Counterattack a single enemy. Potency increases the less HP the user has. (Maximum increase: +100)',
    pp: 1,
    skillCategories: ['Damage', 'Counter'],
    activationWindow: 'afterEnemyAttacksActive',
    targeting: {
  ...
  },
  {
    id: 'passiveMiracle',
    type: 'passive',
    name: 'Passive Miracle',
    description:
      "Activates after receiving an ally's passive skill. Restore minor HP and grant +1 PP to an ally.",
    pp: 1,
    skillCategories: ['Heal'],
    activationWindow: 'afterReceivingAllyPassive',
    targeting: {
      group: 'Ally',
      pattern: 'Single',
    },
  ...
  },
  {
    ...
    name: 'Saints Barrier',
    description:
      'Activates before an ally is attacked. Reduce damage taken by an ally by 50% for one attack. Also prevents them from being debuffed.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'beforeAllyAttacked',
    targeting: {
  ...
  },
  {
    ...
    description:
      'Activates at the start of a battle. Grants all allies HP regeneration and +10% Defense.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Curing Heal',
    description:
      'Activates after an ally is hit by an attack. Restore minor HP to an ally. Remove all of their debuffs.',
    pp: 1,
    skillCategories: ['Heal'],
    activationWindow: 'afterAllyHit',
    targeting: {
  ...
  },
  {
    ...
    description:
      'Activates at the start of a battle. Attack a row of enemies with a magic first strike. Inflicts Stun. Grants the user +1 summoned faeries.',
    pp: 1,
    skillCategories: ['Damage'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    description:
      'Activates after using an active skill. Grants the user +1 AP and +1 summoned faeries.',
    pp: 2,
    skillCategories: ['Utility'],
    activationWindow: 'afterUsingActiveSkill',
    targeting: {
  ...
  },
  {
    ...
    description:
      'Activates at the start of a battle. Restore moderate HP to a row of allies. Grants a buff that negates a single debuff. Grants the user +1 summoned faeries.',
    pp: 1,
    skillCategories: ['Heal'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Wild Kick',
    description:
      "Activates after an enemy guards against an ally's attack. Attack a single enemy. Inflicts Stun and Guard Seal.",
    pp: 1,
    skillCategories: ['Damage', 'Pursuit'],
    activationWindow: 'afterEnemyGuards',
    targeting: {
  ...
  },
  {
    ...
    name: 'Hawk Eye',
    description:
      "Activates before attacking with an active skill. Makes the user's next attack a truestrike and a guaranteed critical.",
    pp: 2,
    skillCategories: ['Utility'],
    activationWindow: 'beforeAttackingActive',
    targeting: {
  ...
  },
  {
    ...
    name: 'Advance Cover',
    description:
      'Activates before an ally is attacked. Cover an ally with a medium guard. Grants the user +1 AP.',
    pp: 1,
    skillCategories: ['Cover'],
    activationWindow: 'beforeAllyAttacked',
    targeting: {
  ...
  },
  {
    ...
    description:
      "Activates after an enemy attacks with an active skill. Counterattack a single enemy. Inflicts Burn and removes all of target's Buffs.",
    pp: 1,
    skillCategories: ['Damage', 'Counter'],
    activationWindow: 'afterEnemyAttacksActive',
    targeting: {
  ...
  },
  {
    ...
    name: 'Parting Death',
    description:
      'Activates at the end of a battle. Attack a single enemy. Inflicts Deathblow if the target has 50% HP or less.',
    pp: 1,
    skillCategories: ['Damage'],
    activationWindow: 'endOfBattle',
    targeting: {
  ...
  },
  {
    ...
    description:
      'Activates after an ally attacks with an active skill. Follow-up attack a single enemy. User recovers HP equal to 50% of damage dealt. Grants the user +1 PP vs afflicted targets.',
    pp: 1,
    skillCategories: ['Damage', 'Pursuit'],
    activationWindow: 'afterAllyAttacksActive',
    targeting: {
  ...
  {
    id: 'eyeOfTheWarriorPrincess',
    type: 'passive',
    name: 'Eye of the Warrior Princess',
    description:
      'Activates at the start of a battle. Inflicts Attack -20% and Initiative -10 on all enemies.',
    pp: 1,
    skillCategories: ['Sabotage'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Painbringer',
    description:
      'Activates before being attacked. Grants the user +1 AP, +20% Attack, and +10 Initiative. (Effect stacks.)',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'beforeBeingAttacked',
    targeting: {
  ...
  },
  {
    ...
    name: 'Scornful Dead',
    description:
      'Activates at the start of a battle. Force all enemies to focus attacks on the user. User will evade attacks up to two hits.',
    pp: 1,
    skillCategories: ['Sabotage'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Evil Cover',
    description:
      'Activates before an ally is attacked. Cover an ally with a medium guard. Steals 1 PP from that ally.',
    pp: 1,
    skillCategories: ['Cover'],
    activationWindow: 'beforeAllyAttacked',
    targeting: {
  ...
  },
  {
    ...
    name: 'Dark Step',
    description:
      'Activates before being attacked. Evade a single hit. Grants the user +25 Evasion.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'beforeBeingAttacked',
    targeting: {
  ...
  },
  {
    ...
    name: 'Dark Conferral',
    description:
      "Activates before an ally attacks with a Physical Active skill. Add magical damage and Blindness to an ally's next attack. (50 potency)",
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'beforeAllyAttacksPhysicalActive',
    targeting: {
  ...
  },
  {
    ...
    name: 'Cursed Gaol',
    description:
      'Activates before an enemy uses an active skill. Inflicts Attack -50% to a single enemy. Inflicts Critical Seal',
    pp: 1,
    skillCategories: ['Sabotage'],
    activationWindow: 'beforeEnemyAttacks',
    targeting: {
  ...
  },
  {
    ...
    name: 'Ominous Wall',
    description:
      'Activates at the start of a battle. Grants all allies a buff that negates one attack.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  {
    id: 'sanguineConferral',
    type: 'passive',
    name: 'Sanguine Conferral',
    description:
      "Activates before an ally attacks with a Physical Active skill. Add magical damage to an ally's next attack. (50 potency.) User recovers HP equal to 50% of damage dealt.",
    pp: 2,
    skillCategories: ['Utility'],
    activationWindow: 'beforeAllyAttacksPhysicalActive',
    targeting: {
  ...
  {
    id: 'thunderousConferral',
    type: 'passive',
    name: 'Thunderous Conferral',
    description:
      "Activates before an ally attacks with a Physical Active skill. Add magical damage and Stun to an ally's next attack. (50 potency)",
    pp: 2,
    skillCategories: ['Utility'],
    activationWindow: 'beforeAllyAttacksPhysicalActive',
    targeting: {
  ...
  },
  {
    ...
    name: 'Ice Conferral',
    description:
      "Activates before an ally attacks with a Physical Active skill. Add magical damage and Freeze to an ally's next attack. (50 potency)",
    pp: 2,
    skillCategories: ['Utility'],
    activationWindow: 'beforeAllyAttacksPhysicalActive',
    targeting: {
  ...
  },
  {
    ...
    description:
      "Activates before an ally attacks with a Physical Active skill. Add magical damage and Burn to an ally's next attack. (50 potency)",
    pp: 2,
    skillCategories: ['Utility'],
    activationWindow: 'beforeAllyAttacksPhysicalActive',
    targeting: {
  ...
  },
  {
    ...
    name: "Bear's Den",
    description:
      'Activates at the start of a battle. Grants +20% Phys. Defense to all allies. Grants +50% Guard Rate to Bestral targets.',
    pp: 2,
    skillCategories: ['Utility'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Wolf Pack',
    description:
      'Activates at the start of a battle. Grants +20% Phys. Attack to all allies. Grants +50% Critical Rate to Bestral targets.',
    pp: 2,
    skillCategories: ['Utility'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Dawn Horn',
    description:
      'Activates at the start of a battle. Grants all allies immunity to Stun and +20% Guard Rate.',
    pp: 2,
    skillCategories: ['Utility'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Relic Heal',
    description:
      'Activates after an ally is hit by an attack. Restore moderate HP to an ally. Grants HP regeneration.',
    pp: 2,
    skillCategories: ['Heal'],
    activationWindow: 'afterAllyHit',
    targeting: {
  ...
  },
  {
    ...
    name: 'Party Aid',
    description:
      'Activates at the end of a battle. Restore 25% HP to all allies.',
    pp: 2,
    skillCategories: ['Heal'],
    activationWindow: 'endOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Wide Pursuit',
    description:
      'Activates after an ally attacks with an active skill. Follow-up attack a row of enemies.',
    pp: 2,
    skillCategories: ['Damage', 'Pursuit'],
    activationWindow: 'afterAllyAttacksActive',
    targeting: {
  ...
  },
  {
    ...
    description:
      'Activates at the start of a battle. Attack a single enemy with a first strike. Inflicts Phys. Defense -50%.',
    pp: 2,
    skillCategories: ['Damage'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    description:
      'Activates before being hit by a magic attack. Negate a single magic attack targeting the user. Grants the user +2 PP.',
    pp: 2,
    skillCategories: ['Utility'],
    activationWindow: 'beforeBeingHitMagic',
    targeting: {
      group: 'Self',
      pattern: 'Single',
    },
  ...
  },
  {
    ...
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'afterBeingAttacked',
    targeting: {
      group: 'Self',
      pattern: 'Single',
    },
  ...
  },
  {
    ...
    name: 'Inspiration',
    description:
      'Activates before an ally attacks with an Active skill. Buff an ally for their next attack. Grants +30% Attack, +50% Critical damage, and -50 Accuracy.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'beforeAllyAttacksActive',
    targeting: {
  ...
  },
  {
    ...
    name: 'Powerful Call',
    description:
      "Activates before an ally attacks with an Active skill. Grant an ally +30% Phys. Attack for an ally's next attack.",
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'beforeAllyAttacksActive',
    targeting: {
  ...
  },
  {
    ...
    name: 'Passive Cure',
    description:
      "Activates after an ally is debuffed. Remove Passive Seal from an ally. Restores 10% of target's HP.",
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'afterAllyDebuffed',
    targeting: {
  ...
  },
  {
    ...
    name: 'Guard Cure',
    description:
      "Activates after an ally is debuffed. Remove Guard Seal from an ally. Restores 10% of target's HP.",
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'afterAllyDebuffed',
    targeting: {
  ...
  },
  {
    ...
    name: 'Stun Cure',
    description:
      "Activates after an ally is debuffed. Remove Stun from an ally. Restores 10% of target's HP.",
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'afterAllyDebuffed',
    targeting: {
  ...
  },
  {
    ...
    name: 'Passive Cure',
    description:
      "Activates after an ally is debuffed. Remove Blindness from an ally. Restores 10% of target's HP.",
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'afterAllyDebuffed',
    targeting: {
  ...
  },
  {
    ...
    name: 'Freeze Cure',
    description:
      "Activates after an ally is debuffed. Remove Freeze from an ally. Restores 10% of target's HP.",
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'afterAllyDebuffed',
    targeting: {
  ...
  },
  {
    ...
    name: 'Poison Cure',
    description:
      "Activates after an ally is debuffed. Remove Poison from an ally. Restores 10% of target's HP.",
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'afterAllyDebuffed',
    targeting: {
  ...
  },
  {
    ...
    name: 'Fire Cure',
    description:
      "Activates after an ally is debuffed. Remove Burn from an ally. Restores 10% of target's HP.",
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'afterAllyDebuffed',
    targeting: {
  ...
  },
  {
    ...
    name: 'United Front',
    description:
      'Activates at the start of a battle. Grants all allies buffs based on the number of enemies minus the number of allies. (1: Grants +30 Initiative. 2: Grants +50% Defense. 3: Negates attacks up to 5 hits.)',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    description:
      'Activates at the start of a battle. Grants a row of allies buffs based on the number of flying allies in the row. (1: Grants +20% Critical Rate. 2: Grants +20 Accuracy. 3: Grants +20% Attack.)',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    description:
      'Activates at the start of a battle. Grants a row of allies buffs based on the number of armored allies in the row. (1: Grants +20% Guard Rate. 2: Grants Stun Immunity. 3: Grants +20% Defense.)',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Quick Action',
    description:
      'Activates at the start of a battle. Grants an ally +15 Initiative for their next action. (Cannot target self.)',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'startOfBattle',
    skillFlags: ['ExcludeSelf'],
  ...
  },
  {
    ...
    name: 'War Cry',
    description:
      'Activates at the start of a battle. Grants the user +20% Phys. Attack.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    name: 'Impetus Stance',
    description:
      'Activates at the start of a battle. Grants the user +1 AP and -50% Attack.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'startOfBattle',
    targeting: {
  ...
  },
  {
    ...
    description:
      'Activates after an ally is healed. Restore minor HP to one ally above their normal limits. (Can heal up to 150% above maximum HP.)',
    pp: 1,
    skillCategories: ['Heal', 'Pursuit'],
    activationWindow: 'afterAllyHealed',
    skillFlags: ['Overheal'],
    targeting: {
      group: 'Ally',
      pattern: 'Single',
  ...
  },
  {
    ...
    name: 'Self-Care',
    description:
      'Activates after the user is debuffed. Remove all debuffs from the user.',
    pp: 1,
    skillCategories: ['Utility'],
    activationWindow: 'afterUserDebuff',
    targeting: {
  ...
  },
  {
    ...
    description:
      "Activates after an enemy attacks with an active skill. Counterattack a single enemy. Removes all of target's buffs.",
    pp: 1,
    skillCategories: ['Damage', 'Counter'],
    activationWindow: 'afterEnemyAttacksActive',
    targeting: {
  ...
  },
  {
    ...
    name: 'Vanitas',
    description:
      'Activates after an ally is hit by an attack. Counterattack a single enemy. Inflicts Blindness and Poison.',
    pp: 1,
    skillCategories: ['Damage', 'Counter'],
    activationWindow: 'afterAllyHit',
    innateAttackType: 'Ranged',
  ...
  },
  {
    ...
    name: 'Counter',
    description:
      'Activates after an enemy attacks with an active skill. Counterattack a single enemy.',
    pp: 1,
    skillCategories: ['Damage', 'Counter'],
    activationWindow: 'afterEnemyAttacksActive',
    targeting: {
